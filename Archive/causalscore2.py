...
def test_method(num,arcs_ratio,nodes,timesteps, islands,datapoints,values, sema=None):
    ...
    # for rep in range(30):
        ...
        # true_dbn.saveBIFXML(f"/gpfs/home5/jvwijk/outputs/groundtruths/structure{num}_{rep}.bifxml")
        ...
        #             learned.saveBIFXML(f"/gpfs/home5/jvwijk/outputs/structures/structure{num}_{rep}_{subpoints}_{alg}_constraint.bifxml")
        ...
        #                     generator.learn_time_structure(subpoints)
        #                     learned = generator.get_structure()
        #                     learned.saveBIFXML(f"/gpfs/home5/jvwijk/outputs/structures/structure{num}_{rep}_{subpoints}_{alg}_{metric}.bifxml")
...
def run_sims():
    ...
    for i, params in enumerate(parameters):
        for batch in range(batches):   
            ...
            total += test_method(i+batch*len(parameters),r,n,t,islands,d,v)
